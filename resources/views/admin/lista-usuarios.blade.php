          ...
          <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-10">
                            <h3 class="card-title mb-0">Listagem de usuários</h3>
                        </div>
                        <div class="col-sm-2">
                            <a href="{{ route('admin.form-usuarios') }}" class="btn btn-success btn-sm" data-placement="top">Adicionar</a>
                        </div>
                    </div>
                </div>
                <!-- /.card-header -->
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td width="10%">
                                                    <form action="{{ route('usuarios.destroy', $item->id) }}" method="post">
                                                        <a href="{{ route('admin.form-edit-usuarios',$item->id)}}" class="btn btn-primary btn-sm" data-placement="top"><i class="fas fa-edit"></i></a>
                                                        @csrf
                                                        @method('DELETE')
