            ...
            <div class="col-sm-8">
                <form action="{{route('site.questionariostore')}}" method="POST" class="needs-validation mt-5 mb-5" novalidate>
                    ...
                    <div class="form-group col-sm-12">
                        <label for="q1" class="label">1) Você gostaria de ter sua profissão regulamentada?</label>
                    ...
                    <div class="form-group col-sm-5">
                        <label for="q2" class="label">2) Como vc se classifica?</label>
                        <select class="custom-select answer col-sm-8" name="q2" id="q2" required>
                    ...
                    <div class="form-group col-sm-6">
                        <label for="q3" class="label">3) Qual sua categoria profissional</label>
                        <select class="custom-select answer col-sm-6" name="q3" id="q3" required>
                          <option value="">Escolha uma opção</option>
                    ...
                    <div class="form-group col-sm-9">
                        <label for="q4" class="label">4) Na classificação profissional você  se encaixa como?</label>
                        <select class="custom-select answer col-sm-9" name="q4" id="q4" required>
                          <option value="">Escolha uma opção</option>
                    ...
                    <div class="form-group col-sm-9">
                        <div class="row">
                            <div class="col-sm-9">
                                <label for="q5" class="label">5) Qual sua cidade base de atuação?</label>
                                <select class="custom-select answer col-sm-8" name="q5" id="cidades" required>
                                </select>
                            </div>
                            <div class="col-sm-3">
                                <label for="q5uf" class="label">UF</label><br>
                                <select class="custom-select answer col-sm-8" name="q5uf" id="estados" required>
                    ...
                    <div class="form-group col-sm-10">
                        <label for="q6" class="label">6) Você gostaria que a classe tivesse benefícios?</label>
                        <div class="form-check answer">
                            <div class="custom-control custom-radio custom-control-inline">
                    ...
                    <div class="form-group col-sm-10">
                        ...
                        <input type="text" class="form-control answer col-sm-8" name="q6_desc" id="q6_desc" value="" disabled>
                    </div>
                    <div class="form-group col-sm-12">
                        <label for="q7" class="label">7) Gostaria de participar de uma negociação coletiva para parametrizar a classe?</label>
                        <div class="form-check answer">
                            <div class="custom-control custom-radio custom-control-inline">
                    ...
                    <div class="form-group col-sm-12">
                        <label for="q8" class="label">8) Quando é contratado , assina o contrato de trabalho?</label>
                        <div class="form-check answer">
                            <div class="custom-control custom-radio custom-control-inline">
                    ...
                    <div class="form-group col-sm-12">
                        <label for="q9" class="label">9) Qual sua faixa de ganho de job por período?</label>
                    ...
                    <div class="form-group col-sm-12">
                        <label for="q10" class="label">10) Você consegue ter intervalo para  fazer horário  almoço ou jantar? Senão, o que acontece?</label>
                        <select class="custom-select answer col-sm-8" name="q10" id="q10" required>
                            <option value="">Escolha uma opção</option>
                    ...
                    <div class="form-group col-sm-12">
                        <label for="q11" class="label">11) Quem paga sua alimentação?</label>
                        <div class="form-check answer">
                            <div class="custom-control custom-radio custom-control-inline">
                    ...
                    <div class="form-group col-sm-12">
                        <label for="q12" class="label">12) Você usa  seu veiculo para chegar ao trabalho</label>
                        <div class="form-check answer">
                            <div class="custom-control custom-radio custom-control-inline">
                    ...
                    <div class="form-group col-sm-12">
                        <label for="q13" class="label">13) Quando é contratado você tem seguro de Acidentes Pessoais e responsabilidade Civil</label>
                        <div class="form-check answer">
                            <div class="custom-control custom-radio custom-control-inline">
                    ...
                    <div class="form-group col-sm-6">
                        <label for="q14" class="label">14) Em média qual sua carga horária diária?</label>
                        <select class="custom-select answer col-sm-7" name="q14" id="q14" required>
                            <option value="">Escolha uma opção</option>
                    ...
                    <div class="form-group col-sm-12">
                        <label for="q15" class="label">15) Quando ultrapassa esta carga horário vc recebe reajuste de valores?</label>
                        <div class="form-check answer">
                            <div class="custom-control custom-radio custom-control-inline">
                    ...
                    <div class="form-group col-sm-12">
                        <label for="q16" class="label">16) O contratante disponibiliza acessórios de segurança ou suporte para trabalho? Quais?</label>
                        <select class="custom-select answer col-sm-3" name="q16" id="q16" required>
                            <option value="">Escolha uma opção</option>
                    ...
                    <div class="form-group col-sm-12">
                        <label for="q17" class="label">17) O contratante disponibiliza um lugar seguro para vc deixar seus pertences?</label>
                        <div class="form-check answer">
                            <div class="custom-control custom-radio custom-control-inline">
                    ...
                    <div class="form-group col-sm-12">
                        <label for="q18" class="label">18) Quando a comunicação é feita através de seu celular, você recebe reembolso pra isso?</label>
                        <div class="form-check answer">
                            <div class="custom-control custom-radio custom-control-inline">
                    ...
                    <div class="form-group col-sm-12">
                        <label for="q19" class="label">19) Em caso de afastamento de trabalho, você tem instabilidade contratual?</label>
                        <div class="form-check answer">
                            <div class="custom-control custom-radio custom-control-inline">
                    ...
                    <div class="form-group col-sm-10">
                        <label for="q20" class="label">20) O que acontece se vc sofrer um acidente dentro do local de trabalho?</label>
                    ...
                    <div class="form-group col-sm-4">
                        <label for="q21" class="label">21) Qual sua faixa etária</label>
                    ...
                    <div class="form-group col-sm-12">
                        <label for="q22" class="label">22) Você recebe pelo serviços prestados ao final de cada entrega? Senão, apontar o prazo de pagamento.</label>
                        <select class="custom-select answer col-sm-3" name="q22" id="q22" required>
                            <option value="">Escolha uma opção</option>
                            <option value="Sim">Sim</option>
                            <option value="Não">Não</option>
                    ...
                    <div class="form-group col-sm-12">
                        <label for="q23" class="label">23) O que acontece se houver atraso em seu pagamento?</label>
                        <div class="form-check answer">
                            <div class="custom-control custom-radio custom-control-inline">
                    ...
                    <div class="form-group col-sm-12">
                        <label for="q24" class="label">24) Você concordaria em ter um representante legal, que buscasse  a regulamentação da profissão e melhorias gerais para classe.</label>
                        <div class="form-check answer">
                            <div class="custom-control custom-radio custom-control-inline">
                    ...
                    <div class="form-group col-sm-7">
                        <label for="q25" class="label">25) Qual seu receio hoje depois do Corona Virus?</label>
                    ...
                    <div class="form-group col-sm-10">
                        <label for="q26" class="label">26) Quer  contar algum fato importante ou dar alguma sugestão?</label>
                        <textarea class="form-control" name="q26" id="q26" rows="3" maxlength="255" placeholder="Enter ..."></textarea>
                    </div>
                    <div class="form-group col-sm-12">
                        <label for="q27" class="label">27) E por ultimo, se você gostaria de se tornar imediatamente um associado? Não haverá nenhum ônus.</label>
                        <div class="form-check answer">
                            <div class="custom-control custom-radio custom-control-inline">
