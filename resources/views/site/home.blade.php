            ...
            <div style="padding: 60px; background-image: url('images/bg_texto.png');">
              <h4 class="font_4">
                <span style="color: #1316a3;">
                    ...
                    <strong style="color: #ff7000;">#anprotece</strong>
                </span>
              </h4>
            </div>
          </div>
    ...
    <div class="container">
        ...
        <div class="row ml-1 mr-1" style="margin-top: 150px;">
            ...
            <p class="textos mb-5">
                ...
                Mudar essa realidade, buscar a promoção e valorização do setor com transparência  e foco prioritário na regulamentação
                é a nossa meta, nossa Vocação e nossa Razão de Ser.
            </p>
        </div>
        <!-- ./PÁGINA 1 -->
        <a name="page2"></a>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <ul class="textos_propositos mt-5">
                    <li>
                        Agregar e lutar pelos  interesses dos profissionais do setor.
                    </li>
                    <li>
                        Buscar a integração e o fortalecimento da categoria , defendendo melhorias legislativas,
                        burocráticas e judiciais que possam contribuam positivamente para todos.
                    </li>
                    <li>
                        Coordenar , orientar os interesses dos associados através de representatividade e jurisdição em todo território nacional.
                    </li>
                    <li>
        ...
        <div class="row">
            <div class="col-sm-4">
                <img src="images/parcerias01.jpg" class="img-fluid mb-2" />
            </div>
            <div class="col-sm-4">
                <img src="images/parcerias02.jpg" class="img-fluid mb-2" />
            </div>
            <div class="col-sm-4">
                <img src="images/parcerias03.jpg" class="img-fluid mb-2" />
            </div>
        </div>
        <p class="textos mb-5 text-center">
            Efetivando sua razão de ser, a Anprotec irá buscar sistematicamente estabelecer  parcerias empresariais visando abraçar desafios maiores,
            agregar valor a sua marca  e principalmente oferecer aos seus associados a otimização de seu trabalho como um todo.
